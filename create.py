...
receipt1 = Receipts(most_expensive=5.09, cost_of_alcohol=0, date_of_reciept='2021/06/23', receipt_total=11.36, takeaway=True, delivery_fee=1.99, delivery_time_mins=28, store='mcdonalds', shop=mcdonalds)
